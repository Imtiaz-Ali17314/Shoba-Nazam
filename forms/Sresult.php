...
$sql= "SELECT b.btid,b.date,s.sname,s.fathername,s.code,s.class,bt.name,b.detail from student s
  inner join benazmi b on s.id=b.sid 
  inner join btype bt on b.btid=bt.id where b.date like '%$search%' or s.sname like '%$search%' or s.fathername like '%$search%'
  or s.code = '$search' or s.class like '%$search%' or bt.name like '%$search%' or b.detail like '%$search%' order by b.date asc " ;
...
<html dir="rtl">
    ...
    <script src="../java/Sresult.js"> </script>
